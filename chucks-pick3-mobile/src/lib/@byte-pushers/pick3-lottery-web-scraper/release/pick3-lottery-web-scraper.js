...
module.exports = BaseWebScraper; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
function DrawingTimeInFutureException(drawingTime, drawingDate, expectedDrawTime) {
  ...
  this.toString = function () {
    return String.format('DrawingTimeInFutureException: the requested drawing time "{1}" is in the future. Check back on {2} after {3}', this.drawingTime, this.drawingDate, this.expectedDrawTime);
  };
}
...
module.exports = DrawingTimeInFutureException; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
function DrawingTimeNotFoundException(drawingTime, drawingDate) {
  ...
  this.toString = function () {
    return String.format('DrawingTimeNotFoundException: the requested drawing time "{1}" was not available for date {2}', this.drawingTime, this.drawingDate);
  };
}
...
module.exports = DrawingTimeNotFoundException; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
function DrawingYearNotAvailableException(drawingYear) {
  ...
  this.toString = function () {
    return String.format('DrawingYearNotAvailableException: data is not available for the requested drawing year "{1}".', this.drawingYear);
  };
}
...
module.exports = DrawingYearNotAvailableException; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
module.exports = Exception; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
module.exports = HtmlParseException; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
function WinningNumberNotFoundException(digit1, digit2, digit3) {
  ...
  this.toString = function () {
    return String.format('WinningNumberNotFoundException: Cound not find winning number.  Num1: "{1}",  Num2: "{2}",  Num3: "{3}"', this.digit1, this.digit2, this.digit3);
  };
}
...
module.exports = WinningNumberNotFoundException; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
module.exports = Pick3LotteryWebScrapingService; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
module.exports = TexasPick3Lottery; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
  ...
  this.scrapeUrlForYear = function (targetDate) {
    var targetYear = targetDate.getFullYear(),
      ...
      targetUrl = Object.isFunction($html.find)
        ? $html
            .find("#Pick3PastWinningNumbers")
            .find("select > option:contains(" + targetYear + ")")
            .attr("value")
        : $html("#Pick3PastWinningNumbers")
            .find("select > option:contains(" + targetYear + ")")
            .attr("value"),
...
module.exports = TexasPick3UrlScraper; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
...
function TexasPick3WebScraper(TxPick3WebScraperConfig) {
  ...
  function scrapeDrawDateTdElement(drawingDate) {
    var $drawDateTdElement = Object.isFunction($.find) ? $.find("tr > td:first-child:contains(" + drawingDate + ")") : $("tr > td:first-child:contains(" + drawingDate + ")");
  ...
  function parseTargetDrawDateSection($targetTrElement) {
    var tdElements = $targetTrElement.children("td"),
      result = { morningTdElements: [], dayTdElements: [], eveningTdElements: [], nightTdElements: [] },
      columnCount = 0;
  ...
  function scrapeWinningNumber(parsedDrawDateSection) {
    ...
    num1 = parsedDrawDateSection[0] && parsedDrawDateSection[0].children[0] && parsedDrawDateSection[0].children[0].data ? removeNewLineBytes(parsedDrawDateSection[0].children[0].data).trim() : parsedDrawDateSection[0] && parsedDrawDateSection[0].innerText ? parsedDrawDateSection[0].innerText.trim() : null;
    num2 = parsedDrawDateSection[1] && parsedDrawDateSection[1].children[0] && parsedDrawDateSection[1].children[0].data ? removeNewLineBytes(parsedDrawDateSection[1].children[0].data).trim() : parsedDrawDateSection[1] && parsedDrawDateSection[1].innerText ? parsedDrawDateSection[1].innerText.trim() : null;
    num3 = parsedDrawDateSection[2] && parsedDrawDateSection[2].children[0] && parsedDrawDateSection[2].children[0].data ? removeNewLineBytes(parsedDrawDateSection[2].children[0].data).trim() : parsedDrawDateSection[2] && parsedDrawDateSection[2].innerText ? parsedDrawDateSection[2].innerText.trim() : null;
  ...
  this.findLastDrawnWinningNumber = function (drawingDate, drawingTime) {
    var lastDrawnWinningNumber = 0,
      digits = [],
      $drawDateDivElement = Object.isFunction($.find) ? $.find("div.large-6.cell > div.homePageCell:contains(" + drawingDate + " " + drawingTime + ")") : $("div.large-6.cell > div.homePageCell:contains(" + drawingDate + " " + drawingTime + ")");
...
module.exports = TexasPick3WebScraper; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
/**
 * Created by kalexmills on 7/20/18.
 */
...
module.exports = UrlScraper; /*jshint esversion: 6 */
/*jslint node: true, white: true, for: true, es6: true, this: true */
