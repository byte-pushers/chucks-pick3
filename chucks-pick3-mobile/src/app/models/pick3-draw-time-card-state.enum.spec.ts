...
//property Key
  it('should return card.draw.time.state.drawn',  () => {
    const propertyKey =  enumValue.getPropertyKey(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.DRAWN);
  ...
  it('should return card.draw.time.state.not.drawn.yet.with.generated.picks',  () => {
    const propertyKey =  enumValue.getPropertyKey(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.NOT_DRAWN_YET_WITH_GENERATED_PICKS);
  ...
  it('should return card.draw.time.state.draw.time.enum.night',  () => {
    const propertyKey =  enumValue.getPropertyKey(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.DRAWN_WITH_GENERATED_PICKS_WITH_NO_WINNERS);
  ...
  it('should return card.draw.time.state.drawn.with.generated.picks.with.winners',  () => {
    const propertyKey =  enumValue.getPropertyKey(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.DRAWN_WITH_GENERATED_PICKS_WITH_WINNERS);
  ...
  it('should return NOT_DRAWN_YET_WITH_GENERATED_PICKS',  () => {
    const toStringValue = enumValue.toString(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.NOT_DRAWN_YET_WITH_GENERATED_PICKS);
  ...
  it('should return DRAWN_WITH_GENERATED_PICKS_WITH_NO_WINNERS',  () => {
    const toStringValue = enumValue.toString(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.DRAWN_WITH_GENERATED_PICKS_WITH_NO_WINNERS);
  ...
  it('should return DRAWN_WITH_GENERATED_PICKS_WITH_WINNERS',  () => {
    const toStringValue = enumValue.toString(Pick3DrawTimeCardStateEnum.Pick3DrawTimeCardStateEnum.DRAWN_WITH_GENERATED_PICKS_WITH_WINNERS);
