...
describe('NavigationEnum', () => {
  ...
  it('should return NavigationEnum.gotoHome enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.gotoHome,
      'did not return NavigationEnum.gotoHome');
  });
  ...
  it('should return NavigationEnum.gotoPreviousWinningNumber enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.gotoPreviousWinningNumber,
      'did not return NavigationEnum.gotoPreviousWinningNumber');
  });
  ...
  it('should return NavigationEnum.gotoGenerateNumber enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.gotoGenerateNumber,
      'did not return NavigationEnum.gotoGenerateNumber');
  });
  ...
  it('should return NavigationEnum.gotoViewPicks enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.gotoViewPicks,
      'did not return NavigationEnum.gotoGenerateNumber');
  });
  ...
  it('should return NavigationEnum.viewPicksDisabled enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.viewPicksDisabled,
      'did not return NavigationEnum.viewPicksDisabled');
  });
  ...
  it('should return NavigationEnum.generatePicksDisabled enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.generatePicksDisabled,
      'did not return NavigationEnum.generatePicksDisabled');
  });
  ...
  it('should return NavigationEnum.onViewEnabledHome enum', function () {
    ...
    expect(navigationValue).toBe(NavigationEnum.NavigationEnum.onViewEnabledHome,
      'did not return NavigationEnum.onViewEnabledHome');
  });
