...
export class PreviousPicksDateSectionComponent implements OnInit, OnDestroy {
  public id = -1;
  ...
  constructor(
    ...
    if (this.routerUrl === '/home') {
      ...
      this.id = ++PreviousPicksDateSectionComponent.counter;
  ...
  /* istanbul ignore next */
  ionViewDidEnter() {
    console.log(`PreviousPicksDateSectionComponent.ionViewDidEnter(): `);
  }
    ...
    this.cardContextSubscription = this.cardContextService.context$.subscribe(
      (context) => {
        ...
        if (
          ...
          console.log(
            'PreviousPicksDateSectionComponent.cardContextService.context$.subscribe() method: context: ',
            context
          );
  ...
  ngOnDestroy(): void {
    console.log(
      `PreviousPicksDateSectionComponent.ngOnDestroy: id: ${this.id}`
    );
    this.data = null;
    ...
    if (this.routerUrl === '/home') {
      PreviousPicksDateSectionComponent.counter--;
      console.log(
        `PreviousPicksDateSectionComponent.ngOnDestroy: counter: ${PreviousPicksDateSectionComponent.counter}`
      );
    }
  }
