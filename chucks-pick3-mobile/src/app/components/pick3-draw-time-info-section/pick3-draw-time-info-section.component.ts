      ...
      .subscribe((currentPick3DrawTimeCard: Pick3DrawTimeCard) => {
        if (
          ...
          this.drawTimes.forEach((drawTime) => {
            ...
            drawTime.setCheckPick3DrawTimeArray(
              currentPick3DrawTimeCard.getCheckPick3DrawTimeArray()
            );
            drawTime.setPick3DrawTimeArray(
              currentPick3DrawTimeCard.getPick3DrawTimeArray()
            );
          }, this);
          console.log(currentPick3DrawTimeCard);
