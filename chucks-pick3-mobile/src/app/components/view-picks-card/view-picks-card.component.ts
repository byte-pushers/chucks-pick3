...
export class ViewPicksCardComponent implements OnInit {
  ...
  constructor(private cardContextService: CardContextService, private toastService: IonicToastNotificationService, private drawTimeService: DrawTimeService, private numbers: NumberUtilityService) {}
