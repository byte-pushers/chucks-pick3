# chucks-pick3-ws serverless API
The chucks-pick3-ws project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
...
Mounting software.bytepushers.chuckspick3.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
    ...
    "Stacks": [
        {
            ...
            "Description": "AWS Serverless Spring API - software.bytepushers.chuckspick3::chucks-pick3-ws", 
            "Tags": [], 
            "Outputs": [
                {
                    "Description": "URL for application",
                    "ExportName": "ChucksPick3WsApi",  
                    "OutputKey": "ChucksPick3WsApi",
